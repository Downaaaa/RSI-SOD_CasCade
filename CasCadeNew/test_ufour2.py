...
from CasCadeUFOUR.stackNet1 import StackedHGNetV1
...
def visualize(img, feature, out_file, imgname):
    ...
    drawn_img = seg_visualizer.draw_featmap(feature, image,
                                            channel_reduction='squeeze_mean', )  # 'select_max''squeeze_mean' topk=6, arrangement=(2, 3)
...
class Test(object):
    ...
    def accuracy(self):
        with torch.no_grad():
            ...
            self.cfg.datapath, mae / cnt, fscore.max() / cnt, len(self.loader.dataset), fps)
            print(msg)
            logger.info(msg)
    ...
    def save(self):
        with torch.no_grad():
            for image, mask, shape, name in self.loader:
                ...
                headp1 = '/data/Hms/resultmapNew/CasUFour12-11-1/' + self.cfg.datapath.split('/')[-1] + 'p1'
                headp2 = '/data/Hms/resultmapNew/CasUFour12-11-1/' + self.cfg.datapath.split('/')[-1] + 'p2'
                headp3 = '/data/Hms/resultmapNew/CasUFour12-11-1/' + self.cfg.datapath.split('/')[-1] + 'p3'
                headp4 = '/data/Hms/resultmapNew/CasUFour12-11-1/' + self.cfg.datapath.split('/')[-1] + 'p4'
...
if __name__ == '__main__':
    ...
    model = '/data/Hms/model_newcas/CasCadeUFour-12-11-1/model-72'
