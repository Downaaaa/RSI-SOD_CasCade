...
def train(Dataset, Network):
    # dataset
    cfg = Dataset.Config(datapath='/userHome/zy/Hms/ACCoNet/dataset/train_dataset/EORSSD/train', savepath='/data/Hms/model_newcas/CasCadeUFour-12-6-2',mode='train', batch=16
                         , lr=1e-3, momen=0.9,
        ...
        if epoch >= 199:
            ...
            if (epoch >= 25 and best_epoch == epoch + 1) or epoch == 41 or epoch == 599:
                ...
                if epoch == 599:
                    ...
                    jsonnum['mse'] = MAEnum
                    with open('/data/Hms/model_newcas/CasCadeUFour-12-6-2/data.json', 'w') as f:
