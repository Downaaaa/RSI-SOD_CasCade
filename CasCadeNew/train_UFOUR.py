...
def train(Dataset, Network):
    # dataset
    cfg = Dataset.Config(datapath='/userHome/zy/Hms/ACCoNet/dataset/train_dataset/EORSSD/train', savepath='/data/Hms/model_newcas/CasCadeUFour-12-11-1',mode='train', batch=16
                         , lr=1e-3, momen=0.9,
    ...
    for epoch in range(cfg.epoch):
        if epoch < 60:
            ...
            if epoch < 80:
                ...
                adjust_lr(optimizer, cfg.lr, epoch - 50, decay_rate=0.5, decay_epoch=50)
        ...
        if epoch >= 49:
            ...
            if (epoch >= 25 and best_epoch == epoch + 1) or epoch == 41 or epoch == 199:
                ...
                if epoch == 199:
                    ...
                    with open('/data/Hms/model_newcas/CasCadeUFour-12-11-1/data.json', 'w') as f:
