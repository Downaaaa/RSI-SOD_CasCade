    ...
    def save(self):
        with torch.no_grad():
            for image, mask, shape, name in self.loader:
                ...
                headp1 = '/data/Hms/resultmapNew/CasUFour12-12-1/' + self.cfg.datapath.split('/')[-1] + 'p1'
                headp2 = '/data/Hms/resultmapNew/CasUFour12-12-1/' + self.cfg.datapath.split('/')[-1] + 'p2'
                headp3 = '/data/Hms/resultmapNew/CasUFour12-12-1/' + self.cfg.datapath.split('/')[-1] + 'p3'
                headp4 = '/data/Hms/resultmapNew/CasUFour12-12-1/' + self.cfg.datapath.split('/')[-1] + 'p4'
...
if __name__ == '__main__':
    ...
    model = '/data/Hms/model_newcas/CasCadeUFour-12-12-1/model-67'
