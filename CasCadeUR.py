...
from DecoderUnit import DecoderRES, MapEnhance, DecoderSegNext
...
class BBBNet(nn.Module):
    def __init__(self, cfg=None):
        ...
        self.decoderRes = DecoderRES(512, 1024, 2048)
    ...
    def forward(self, x,shape=None,mask=None):
        ...
        feature1 = self.HA(torch.sigmoid(outmap), outp)
        feature1 = F.interpolate(feature1, size=x.shape[2:], mode='bilinear', align_corners=True)
        ...
        p2, p11, p12, p13, p14 = self.cas1(input2)
